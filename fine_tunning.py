...
second_train_one.to_json("second-train/data-one.json", force_ascii=False)
second_train_two.to_json("second-train/data-two.json", force_ascii=False)
second_train_theer.to_json("second-train/data-theer.json", force_ascii=False)
